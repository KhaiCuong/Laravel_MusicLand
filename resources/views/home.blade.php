            ...
            <div>
                ...
                <div id="song-1" class="row px-xl-5 pb-3 mt-3" style="display: flex; justify-content: space-around;">
                    <div class="col-lg-2 col-md-6 pb-1">
                            ...
                            <img id="startOrStop" class="img-fluid border-radius-6" src="img/song-1.jpg" alt="Play Button" onclick="StartOrStop('audio/song-1.mp3')">
...
<div>
    ...
    <div class=" py-5">
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="vendor-item border p-4" style="box-sizing: border-box;">
                        <img src="img/vendor-1.jpg" alt="">
                    </div>
                    <div class="vendor-item border p-4" style="box-sizing: border-box;">
                        <img src="img/vendor-2.jpg" alt="">
...
<div class="align-items-center py-3 top-bar music-content" style="background-color: rgba(0, 0, 0, 0.9);z-index:100; height: 100px;  position: fixed ; bottom: 0; right: 0; width:100%;">
    ...
    <div style="display: flex; margin: 0 34px; justify-content: space-between; align-items: center; width:100%; ">
        <div style="display: flex; height:100%; align-items: center; width: 30%;" class="info-song">
            <div style="width: 50px; height: auto; margin-right: 10px;" class="thumbnail-song"> <img src="img/vendor-8.jpg" alt="song img" style="width:100%; height:100%;"></div>
            ...
            <p style="margin-bottom: 0; color: white; font-size:12px; padding-top:2px;" class="artist"> Artis Name</p>
        </div>
